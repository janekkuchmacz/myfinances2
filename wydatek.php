				...
				<div class="row">
					...
					<div class="col-lg-10 wpis">
						...
						<header>
							...
							<h1 class="text-center text-lg-left ml-0">Dodaj wydatek</h1>
						...
						<form action="dodajwydatek.php" method="post">
							...
							<div class="col-lg-4 d-none d-lg-inline-block">
								<i class="icon-money3"></i><i class="icon-minus1"></i><i class="icon-money4"></i>
							</div>
							<div class="pole ml-3">
							...
							<div class="kategoria">
								...
								<h2 class="text-center text-lg-left">Kategoria</h2>
							...
							<div class="przyciskiWydatek">
								...
								<div class="col-md-5 d-inline-block"><input type="submit" value="Dodaj wydatek"></div>
							
								<div class="col-md-4 col-lg-3 col-xl-2 offset-md-1 offset-lg-2 offset-xl-3 d-inline-block">
