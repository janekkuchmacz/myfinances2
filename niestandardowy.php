				...
				<div class="row">
					...
					<div class="col-lg-10  wpis">
						...
						<div class="col-lg-4 d-none d-lg-inline-block">
							...
							<div id="okresczasu">
								<span class="bilansdla">Bilans dla: </span> <span class="kolumnytabeli"><?= "$poczatek"."_"."$koniec"?></span>
							</div>									
...
?>
										...
										<?php
										$incomeQuery=$db->query("SELECT SUM(amount) AS IncomeSum FROM incomes WHERE user_id='$userID' AND ('$poczatek' <= date_of_income) AND ('$koniec' >= date_of_income)");
...
?>
							...
							<div id="wydatki">
								<div id="tabelaWydatki" class="col-lg-6 d-inline-block align-top">
									...
									<?php
										$expenseQuery=$db->query("SELECT SUM(amount) AS ExpenseSum FROM expenses WHERE user_id='$userID' AND ('$poczatek' <= date_of_expense) AND ('$koniec' >= date_of_expense)");
